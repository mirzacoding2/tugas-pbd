                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <?php
                            ...
                            $nik = $_GET['nik'];
                            $data = mysqli_query($con, "SELECT * FROM tb_penduduk WHERE nik='$nik' ");
                        ...
                        ?>
                            <form method="post" action="#">
                                ...
                                <div class="form-group row"><label class="col-sm-2 col-form-label">Agama</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control" name="agama" value="<?php echo $row['agama']; ?>"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="col-sm-10"><input type="text" class="form-control" name="jenis_kelamin" value="<?php echo $row['jenis_kelamin']; ?>"></div>
                                </div>
                                <div class="hr-line-dashed"></div>

                                <div class="form-group row"><label class="col-sm-2 col-form-label">Golongan Darah</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="golongan_darah" value="<?php echo $row['golongan_darah']; ?>"></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group row"><label class="col-sm-2 col-form-label">Status Pernikahan</label>
                                    <div class="col-sm-10"><select class="form-control m-b" name="status_pernikahan" value="<?php echo $row['status_pernikahan']; ?>">
                                        <option>-</option>
                                ...
                                <div class="form-group row"><label class="col-sm-2 col-form-label">Kewarganegaraan</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="warga_negara" value="<?php echo $row['warga_negara']; ?>"></div>
                                </div>
                                <div class="hr-line-dashed"></div>  
